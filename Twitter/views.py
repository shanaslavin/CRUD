...
class PostDetailView(DetailView):
  model=Post
  template_name = 'Twitter/post-detail.html'
...
#Edit a post
def edit(request, pk, template_name='Twitter/edit.html'):
...
#Delete post
def delete(request, pk, template_name='Twitter/confirm_delete.html'):
  post= get_object_or_404(Post, pk=pk)    
  if request.method=='POST':
      post.delete()
      return redirect('index')
